...
class EditItems extends React.Component{
    ...
    render(){
        ...
        <FormControl variant="outlined" className="w-100 whitebg">
                ...
                <br></br><br></br>
                <div className="flex">
                <TextField onChange={this.setName.bind(this)} label="Item Name" variant="outlined" className="w-100 whitebg marginrit" id="itemname"/><TextField type="number" onChange={this.setMoney.bind(this)} label="money" variant="outlined" className="whitebg" id="itemprice"/><br></br>
