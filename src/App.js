...
import { faUserShield, faCube,faUserCog,faCartArrowDown,faPhotoVideo,faDice,faTag} from '@fortawesome/free-solid-svg-icons'
      ...
      <BrowserRouter>
        <div className="sidenavigation w-20 whitebg lilpadding radius">
          ...
          <div id="three" className="padding radius  outliner" onClick={(e)=>this.makeActive("three",e.currentTarget)}>
            <IconMenu text="Manage Homepage" icon={faUserCog} color="gray" />
            </div>
          </Link>
